...
AgentTrace accepts one documented OpenTelemetry Protocol JSON trace shape in addition to its native trace format. This is an interoperability demonstration, not a universal OTLP collector.
