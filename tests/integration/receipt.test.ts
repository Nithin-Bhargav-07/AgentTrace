...
const EXPECTED_A_BYTE_LENGTH = 1_749;
const EXPECTED_A_SHA256 =
  "b80bcb8755c4fba1b20a4bc16ea0e7583ca4748043567d93c95a1e149e86bf7f";
const EXPECTED_B_BYTE_LENGTH = 3_419;
const EXPECTED_B_SHA256 =
  "f6078d01590e2f59eaa97307efbc5d05035816a39a20c53a569c4c3c67b94fd9";
...
describe("complete receipt orchestration", () => {
  it("Fixture A preserves exact bytes and produces a schema-valid Granite export within declared authority", async () => {
    ...
    expect(receipt.schemaVersion).toBe("agent-trace.receipt.v1");
    ...
    expect(receipt.integrity).toStrictEqual({
      ...
      inputFormat: "agent-trace.native-trace.v1",
      schemaVersion: "agent-trace.native-trace.v1",
      adapterName: "nativeTrace",
      adapterVersion: "1.0.0",
      authoritySchemaVersion: "agent-trace.authority.v1",
      policyId: "policy-crm-churn-001",
      canonicalEventSchemaVersion: "agent-trace.canonical-event.v1",
      receiptSchemaVersion: "agent-trace.receipt.v1",
