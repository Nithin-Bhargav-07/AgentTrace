# AgentTrace Team Standards

## Product boundary

AgentTrace provides evidence-backed verification for AI agents. The primary user is an AI operations manager reviewing a completed run. Do not widen the product into live interception, enforcement, general observability, compliance certification, or chain-of-thought capture.
...
- Keep changes inside the current functional scope.
