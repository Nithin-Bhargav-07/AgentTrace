#!/usr/bin/env python3
"""Build the AgentTrace project guide PDF from its editable Markdown source."""
...
OUTPUT = ROOT / "output" / "pdf" / "agent-trace-complete-project-guide.pdf"
...
class GuideDocTemplate(BaseDocTemplate):
    def __init__(self, filename: str):
        super().__init__(
            ...
            topMargin=TOP,
            bottomMargin=BOTTOM,
            title="AgentTrace: The Complete Project Guide",
            author="AgentTrace Authors",
            subject="Technical architecture and HackDevengers documentation",
            creator="AgentTrace guide builder",
        )
...
def draw_cover(canvas, doc) -> None:
    ...
    canvas.drawString(42, PAGE_H - 142, "AgentTrace")
    ...
    screenshot = ROOT / "docs" / "screenshots" / "agent-trace-overview.jpg"
...
def draw_body_chrome(canvas, doc: GuideDocTemplate) -> None:
    ...
    canvas.drawString(LEFT, PAGE_H - 24, "AGENTTRACE")
