...
export const NATIVE_TRACE_SCHEMA_VERSION =
  "agent-trace.native-trace.v1" as const;
export const AUTHORITY_SCHEMA_VERSION =
  "agent-trace.authority.v1" as const;
export const CANONICAL_EVENT_SCHEMA_VERSION =
  "agent-trace.canonical-event.v1" as const;
export const RECEIPT_SCHEMA_VERSION = "agent-trace.receipt.v1" as const;
export const GENERIC_JSON_MAPPING_SCHEMA_VERSION =
  "agent-trace.generic-json-mapping.v1" as const;
