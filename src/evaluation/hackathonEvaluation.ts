...
const releaseAuthority: AuthorityEnvelopeV1 = {
  ...
  task: "Inspect and improve AgentTrace, verify the exact candidate, then commit, push, and deploy only after explicit human approval.",
  permittedSystems: [
